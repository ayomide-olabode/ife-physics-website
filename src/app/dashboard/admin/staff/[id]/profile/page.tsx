...
export default async function AdminStaffProfilePage({
  ...
  return (
    <main className="container mx-auto px-4 py-12 space-y-8 max-w-4xl">
      {!completeness.isComplete && <ProfileCompletenessCard completeness={completeness} />}

      <div>
        <PageHeader title="Staff Profile" description="Edit this staff profile on their behalf." />
      </div>
      ...
      <div className="rounded-lg border bg-card p-6">
        ...
        <EditProfileForm
          ...
          initialMembershipOfProfessionalOrganizations={staff.membershipOfProfessionalOrganizations}
          lastUpdatedAt={staff.updatedAt}
        />
      </div>
          ...
          <div className="rounded-none border bg-card p-6">
            <div className="mb-6 border-b pb-2">
              ...
              <p className="text-base text-muted-foreground mt-1">
                Optional — select a centre/unit this staff is affiliated with.
              </p>
            </div>
